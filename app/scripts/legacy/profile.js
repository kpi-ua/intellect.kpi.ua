$(document).ready(function () {
    ...
    API.getData(["Intellect", "GetAwardsList"], {
        ...
        $.each(data, function (key, value) {
            html += "<div class='panel panel-default'><div class='panel-heading subpage_content_h'>" + key.charAt(0).toUpperCase() + key.substr(1) + "</div><div class='panel-body'>";
