...
const ITeacherSearch: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={'bg-white flex gap-3 h-100 items-center px-8 rounded-lg rounded-tl-none ' + styles['field-shadow']}
      >
        {activeTab === 'alphabetic' ? <Alphabet onLetterSelected={(e) => handleSearch(e, true)} /> : renderInputField()}
      </div>
    </>
  );
};
