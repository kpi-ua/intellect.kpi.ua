...
const InputField: React.FC<Props> = ({onInput = () => {}, onSubmit = () => {}, buttonText, icon = '' as feather.FeatherIconNames, placeholder = '', fieldClass = '', buttonClass = '', value = '', syntheticRef = null}) => {
  ...
  return (
    <>
      ...
      <CommonButton onClick={() => onSubmit(userInput)} onKeyDown={handleKeyDown} className={buttonClass}>{buttonText}</CommonButton>
    </>
  )
}
