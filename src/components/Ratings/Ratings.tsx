  ...
  return (
    <div className="relative justify-between gap-24 mt-4">
      <p className="text-xs text-neutral-600">
        Оцінювання професійної діяльності науково-педагогічних працівників є складовою внутрішньої системи забезпечення
        якості вищої освіти та освітньої діяльності університету.
      </p>
